...
- **Run the tests.** `bun test` — 756 across 89 files, all passing (≈9 min; several files wait on a rate-limited catalog fetch). (This line used
...
1. `bun test` (756 must pass), then `bun scripts/typecheck.ts` (must print OK —
